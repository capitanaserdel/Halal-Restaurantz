...
if (isset($_POST['next'])) {
    ...
    $_SESSION['country'] = $_POST['country']; // Ensure the name matches the select input
...
<div
  ...
  <form action="register.php" method="post">
    <div class="lg:grid grid-cols-2 gap-4">
      ...
      <div class="relative mb-12" data-twe-input-wrapper-init>
        <div>
            ...
            <input required type="text" name="name" id="small-input" class="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-xs focus:ring-orange-500 focus:border-orange-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-orange-500 dark:focus:border-orange-500">
        </div>
      </div>
      <!--Last name input-->
      <div class="relative mb-12" data-twe-input-wrapper-init>
    ...
    <div class="lg:grid grid-cols-1 gap-4">
        <!--Last name input-->
        <div class="relative mb-12" data-twe-input-wrapper-init>
          <div>
              <label for="small-input" class="block mb-4 text-sm font-medium text-gray-900 dark:text-white">Choose Country</label>
              <select id="countries" name="country" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-1.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
      ...
      <div class="lg:grid grid-cols-2 gap-4">
        ...
        <div class="relative mb-12" data-twe-input-wrapper-init>
          <div>
              <label for="small-input" class="block mb-4 text-sm font-medium text-gray-900 dark:text-white">Registration Number</label>
              <input required type="text" name="reg_no" id="small-input" class="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-xs focus:ring-orange-500 focus:border-orange-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-orange-500 dark:focus:border-orange-500">
          </div>
        </div>
      </div>
    <button
